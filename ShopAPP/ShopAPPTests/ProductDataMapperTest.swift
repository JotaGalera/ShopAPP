...
//        let mockeo = mockData["list"] as! [String:Any]
//        let mockProductData : ProductData = ProductData(dict: mockeo)
...
//        }
    ...
    func testConvert() {
        ...
        let mockProductDomain = Product(name: "shirts", brand: "Tommy Hilfiger", price: 80, currency: "€", image: "https://picture.bestsecret.com/static/images/1041/image_31394462_20_620x757_0.jpg")
